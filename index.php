    ...
    <div id="preloader_custom">
        ...
        <div id="spinner_holder">
            ...
            <div id="preloader_content">
                <small style="float: right">juee</small>
                CONVOLUTION<br>2018
            </div>
        </div>
    </div>
        ...
        <div id="login_signup_div_content_in">
            ...
            <div class="log_sin" style="float:right;">
                <form action="php/change.php" method="post" name="update_form" id="update_form">
                    ...
                    <select required="required" id="class" name="class">
                        <optgroup label="class">
                            <option <?php if ($info != '' && $info['class'] == 'Still in School') echo 'selected="selected"'; ?>>
                                Still in School
                            </option>
                            <option <?php if ($info != '' && $info['class'] == 'UG 1st yr') echo 'selected="selected"'; ?>>
                                UG 1st yr
                            </option>
                            <option <?php if ($info != '' && $info['class'] == 'UG 2nd yr') echo 'selected="selected"'; ?>>
                                UG 2nd yr
                            </option>
                            <option <?php if ($info['class'] == 'UG 3rd yr') echo 'selected="selected"'; ?>>UG 3rd yr
                            </option>
                            <option <?php if ($info != '' && $info['class'] == 'UG 4th yr') echo 'selected="selected"'; ?>>
                                UG 4th yr
                            </option>
                        </optgroup>
                    </select>
        ...
        <div id="convo">
            ...
            <div id="home" class="item">
                <div class="inner">
                    ...
                    <span class="foreground hidden" id="second">23rd - 25th February</span>
                </div>
            </div>
            <div id="about" class="item">
                ...
                <div id="content">
                    ...
                    <p class="text" style="padding-bottom: 10px;">
                        <span><i class="fa fa-calendar-check-o"></i> 23-25th February </span>
                        <span> Jadavpur University <i class="fa fa-university"></i></span>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div id="events" style="padding-top: 100px;">
            <div id="circuistic" class="item" style="background: #ffb630">
                ...
                <div id="circuistic_text" style="cursor: default;">Tired of reading only text books? Have an inherent
                    love for circuits?
                    Then this is the event you were looking for. CONVOLUTION 2018 presents CIRCUISTIC 5.0, the circuit
                ...
                <div id="circuistic_contacts" style="cursor: default;">
                    <div id="circuistic_contacts_inner"><i style="color: dodgerblue">Contact: </i>
                        <div> Soumee Guha- +919477784233 ,</div>
                ...
                <div style="margin-top: 1.2vw">
                    <div id="circuistic_buttons_wrapper">
                        <div id="circuistic_buttons_wrapper_inner">
                            ...
                            <div class="circuistic_details_btn circuistic_button pdf"
                            ...
                            <div
                                    ...
                                    class="circuistic_button register" event="circuistic">
                    ...
                    <div class="shrink">
                        ...
                        <div class="algo_buttons_class register" event="algomaniac"
                            ...
                            <div class="tx" <?php if (isset($eventNames['algomaniac'])) echo "status='done'"; ?>>
                                Register<?php if (isset($eventNames['algomaniac'])) echo "ed"; ?></div>
                        </div>
                        <p>
            ...
            <div id="sparkhack_wrapper"
                    ...
                    <div id="todoNoteWrapper1">
                        <div class="note todo_note" id="todo1" style="z-index: 950;">
                            ...
                            <div class="noteDetails"
                                 style="display:none; white-space: pre-wrap;font-size: 0.9em;  width: 30vw">Code,
                                create, build and revolutionize in this third edition of eastern India's biggest
                                Hackathon, SparkHACK. In this 3-Day hackathon, college students as well professionals
                                will strive to build a model which caters to the this year's theme of 'Internet of
                                Things'.Internet of Things (IOT) is one of the most trending technical jargons in
                                today's world.Engineers, designers and researchers will push their creative brains to
                                the farthest limit and develop solutions pertinent to the problem statement in the field
                                of Internet of Things (IOT). So step your game up this spring as there's a lot to be
                                won.Compete with some of the best people of India and your idea just might be the next
                ...
                <div id="sh_in_progress">
                    ...
                    <div id="inprogressNoteWrapper3" class="noteWrapper">
                        <div class="note in_progress_note nr register" id="in_progress3" event="sparkhack"
                             style="<?php if (isset($eventNames['sparkhack'])) echo "cursor:default;"; ?>">
                            ...
                            <div class="noteContent nr tx" <?php if (isset($eventNames['circuistic'])) echo "ed"; ?>>
            ...
            <div id="papier" class="item cs" style="border-color: #931a46">
                ...
                <div class="container">
                    <div id="header">
                        ...
                        <p class="hide" id="convo_papier">Convolution 2018</p>
                        <p class="hide" id="contacts_papier">Sourya Sengupta: +919874899365, Sayan Biswas:
                            +918981608554</p>
                    </div>
                    <div id="body">
            ...
            <div id="decisia" class="item cs" style="border-color: #6e2593">
                <div id="circuistic_buttons_wrapper"
                     style="padding-top: 10vh; transform:scale(1.5  , 1.5);transform-origin: 50%50%;">
                    <div id="circuistic_buttons_wrapper_inner" style="width:45%;transform:translate(3.5% , 0)">

                        <div class="circuistic_details_btn circuistic_button pdf"
                             style="text-decoration:none;float: left;" event="decisia">DETAILS
                        </div>
                        <div
                                style="text-decoration:none;float: right;<?php if (isset($eventNames['decisia'])) echo "cursor:default;"; ?>"
                                class="circuistic_button register" event="decisia">
                            <div class="spinner" style="display:none">
                                <div class="bounce1"></div>
                                <div class="bounce2"></div>
                                <div class="bounce3"></div>
                ...
                <div class="blankDiv" style="background-color: #02964b; min-height:676px;padding-top:10vh">
                    ...
                    <div id="decisiaDetails">Decisia, a nascent decision making event which evaluates your views about
                        all aspects of life to the very core of your thoughts. The uniqueness of the event lies in the
                        multidimensional plethora of layers in the making of this event. Its a simple event of making
                        decisions which will test your analytical skills in dissecting the questions given to you and at
                        the same time your confidence to validate your answers with solid scripted facts which
                        hi-lighten your logic and planning. The questions will be an amalgamation of various primary
                        topics at hand and will have several facets like engineering, economics, medicine, psychology,
                        law, business, sociology ,to it. The rules after that are very simple. The answer that has a
                        brief viewpoint from each of the above fields and is the most simple, logical and elegant wins
                        it all and takes the money home. We rest our case ! Hope to see you soon !
                    </div>
            ...
            <div id="inquizzitive" class="item cs" style="border-color: #352793">
                <div id="circuistic_buttons_wrapper"
                    ...
                    <div id="circuistic_buttons_wrapper_inner" style="width:45%;transform:translate(3.5% , 0)">
                        ...
                        <div class="circuistic_details_btn circuistic_button pdf"
                             style="text-decoration:none;float: left;" event="inquizzitive">DETAILS
                        </div>
                        <div
                                style="text-decoration:none;float: right;<?php if (isset($eventNames['inquizzitive'])) echo "cursor:default;"; ?>"
                                class="circuistic_button register" event="inquizzitive">
                            <div class="spinner" style="display:none">
                                <div class="bounce1"></div>
                                <div class="bounce2"></div>
                                <div class="bounce3"></div>
                ...
                <div class="blankDiv" style="background-color: #042fc3; min-height:676px;padding-top:10vh">
                    ...
                    <div id="decisiaDetails">Let your intellect shine, let the rolling of brain race with every passing
                        of minute. Convolution is coming up with a distinctive quiz competition for school and college
                        students on 3rd March from 4pm-7pm named Inquizzitive. The Quiz is going to be based on General
                        knowledge to make it more practicable for participants.<br>We also boast on bringing one of the
                        best quizmasters in the kolkata quizzing circuit Mr Somnath Chanda and apart from this we have
                    ...
                    <div id="contacts_container">
                        <div id="contact_list" style="float: left">
                            ...
                            <div class="contact">
                                ...
                                <div class="contact_name">Subhashis Bhowmik <span class="info_divider"></span> Secretary
                                    <span class="info_divider"></span> +919836802623
                                </div>
                            </div>

                            <div class="contact">
                                <div class="contact_img"><img src="img/contacts/pratik.jpeg"></div>
                                <div class="contact_name">Pratik Karmakar <span class="info_divider"></span> Joint
                                    Secretary
                            ...
                            <div class="contact">
                                ...
                                <div class="contact_name">Paulomi Bhowmick <span class="info_divider"></span> Marketing
                                    Lead
                            ...
                            <div class="contact">
                                ...
                                <div class="contact_name">Shounak Biswas <span class="info_divider"></span> Logistics
                                    Lead
